...
//CONSULTA PARA CAMBIAR EL TAMAÑO DE UNA FILA
ALTER TABLE `dbhistoriaclinica`.`paciente` 
CHANGE COLUMN `email` `email` VARCHAR(100) NULL DEFAULT NULL ;

//CONSULTA PARA CONCATENER 
SELECT CONCAT(NOMBRE ,' ', APELLIDO) 

//PARA CAMBIAR DATOS DE UNA COLUMNA
UPDATE trabajador set tipo_doc='DNI' WHERE idtrabajador=10
